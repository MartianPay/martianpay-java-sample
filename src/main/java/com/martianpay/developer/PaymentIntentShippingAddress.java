...
/**
 * PaymentIntentShippingAddress represents shipping address information for a payment intent
 */
public class PaymentIntentShippingAddress {
    /**
    ...
    public PaymentIntentShippingAddress() {
    }
